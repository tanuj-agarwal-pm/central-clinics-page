...
export const HeroCarousel = () => {
  ...
  return <section className="relative h-[70vh] md:h-[80vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center">
        ...
        <div className="max-w-2xl animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading text-primary-foreground mb-6 drop-shadow-lg leading-tight">Experience Authentic Kerala Ayurveda</h1>
          ...
          <div className="flex flex-wrap gap-4">
            <Button onClick={scrollToForm} size="lg" className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-lg text-base md:text-lg px-8 py-6 hover-scale">
              Book Your Consultation
            </Button>
            <Button onClick={() => setShowContactOptions(true)} size="lg" variant="outline" className="bg-white/10 text-primary-foreground border-primary-foreground/20 hover:bg-white/20 text-base md:text-lg px-8 py-6">
              Talk to Us
            </Button>
          </div>
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 mt-8">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-primary-foreground" />
              <span className="text-primary-foreground text-sm md:text-base font-medium">Healing Mind, Body and Soul</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-primary-foreground" />
